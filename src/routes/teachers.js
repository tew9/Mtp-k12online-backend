...
const { teacherValidation } = require('../validators/validators');
...
router.post('/teacher/register', requireSignin, teacherValidation, upload.single('teacherPicture'), registerTeacher);
