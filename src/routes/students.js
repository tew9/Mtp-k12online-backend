...
const { studentValidation } = require('../validators/students');
...
router.post('/student/register', requireSignin, studentValidation, upload.single('studentPicture'), registerStudent);
